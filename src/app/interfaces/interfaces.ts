...
export class Convert {
  public static toDataCharacter(json: string): DataCharacter {
      return cast(JSON.parse(json), r("DataCharacter"));
  }

  public static dataCharacterToJson(value: DataCharacter): string {
      return JSON.stringify(uncast(value, r("DataCharacter")), null, 2);
  }
}
